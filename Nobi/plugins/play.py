...
fotoplay = "https://te.legra.ph/file/f1480ad3b1677c326e28b.jpg"
ngantri = "https://telegra.ph/file/b6402152be44d90836339.jpg"
from Nobi import call_py, Nobi, client as Client
owner = "1669178360"
from Nobi.helpers.yt_dlp import bash
from Nobi.helpers.chattitle import CHAT_TITLE
from Nobi.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from Nobi.helpers.thumbnail import gen_thumb
from Nobi.helpers.joiner import AssistantAdd
...
@Nobi.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
...
#play
@Nobi.on(events.NewMessage(pattern="^[/!/]play"))
@AssistantAdd
async def play(event):
    ...
    if (
        ...
        link = f"https://telegram.me/c/{chat.id}/{event.reply_to_msg_id}"
        if replied.audio:
...
@Nobi.on(events.NewMessage(pattern="^[//!]end"))
@is_admin
...
@Nobi.on(events.NewMessage(pattern="^[/!/]vplay"))
@AssistantAdd
...
#playlist
@Nobi.on(events.NewMessage(pattern="^[/!/]playlist"))
@is_admin
...
#leavevc
@Nobi.on(events.NewMessage(pattern="^[/!/]leavevc"))
@is_admin
...
@Nobi.on(events.NewMessage(pattern="^[/!/]skip"))
@is_admin
...
@Nobi.on(events.NewMessage(pattern="^[/!/]pause"))
@is_admin
...
@Nobi.on(events.NewMessage(pattern="^[/!/]resume"))
@is_admin
